...
- Using Bulma will be requied on several HW assignments
- Below, we are going to take advantage of a pre-existing YouTube tutorial on Bulma:
  ...
  - instead, we'll have some companion notes for you as we walk through the first seven videos in the series, and a walkthrough on how to adapt this tutorial so that you can create a multipage responsive web site with Bulma (as a "starter" for for future HW assignments)
...
## Wrap up - let's create a Bulma Template
...
- But let's stop watching these videos for now, and build out a template we can use later in the course
...
![screenshot](_images/_bulma/bulma-1.png)
...
![screenshot](_images/_bulma/bulma-2.png)
...
![screenshot](_images/_bulma/bulma-3.png)

- And here is the responsive version:

![screenshot](_images/_bulma/bulma-4.png)

<hr>

## Submission
- Put all the files (index #1-7 and home.html, JS and images) into a folder
- Name this folder ***lastName-firstInitial*-pe07**
  - -5% for a misnamed folder
- ZIP the folder and post to myCourses

<!-- 
### Step #5 - HW Submission & Beyond
- ***Put all the files (index #1-7 and home.html, JS and images) into a folder, ZIP and POST to myCourses***
- Looking ahead to Project 1 - Checkpoint #1 - what you'll need to start to do in a week or so:
  ...
  - **IMPORTANT**: be sure to have text that clearly distinguished each page from the others - hint: `<h1 class="title is-size-4">Hotdog Finder App</h1>` could go on **app.html**
  - **IMPORTANT**: be sure to have "You are here" cues on each page - hint: make the nav item for the current page bold (or change its background color)
-->
