...
4) Delete the "babble" arrays and move that data to an external JSON file named **babble-data.json**
    ...
    - Important: structure your JSON data to be a simple as possible - it just needs to contain the 3 arrays of babble - so it can look very similar to the simple version 
